...
(script dormant void appearance_characters
    ...
    (sleep 1)
    (custom_animation_loop "chief" "objects\characters\spartans\spartans" "depot:rifle:idle" false)
    (custom_animation_loop "elite" "objects\characters\elite\elite" "combat:pistol:idle:var0" false)
)

(script static void subrank_up
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:helmet" true)
    (sleep 70)
    (custom_animation_loop "chief" "objects\characters\spartans\spartans" "depot:rifle:idle" true)
    (sleep_forever)
)

(script static void rank_up
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:chest" true)
    (sleep 100)
    (custom_animation_loop "chief" "objects\characters\spartans\spartans" "depot:rifle:idle" true)
    (sleep_forever)
)
...
(script static void anim_depot_rifle_helmet_var1
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:helmet:var1" true)
    (sleep 54)
)

(script static void anim_depot_rifle_helmet_var2
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:helmet:var2" true)
    (sleep 211)
)
...
(script static void anim_depot_rifle_chest_var1
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:chest:var1" true)
    (sleep 324)
)
...
(script static void left_shoulder_purchase
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:left_shoulder" true)
    (sleep 102)
    (custom_animation_loop "chief" "objects\characters\spartans\spartans" "depot:rifle:idle" true)
    (sleep_forever)
)
...
(script static void right_shoulder_purchase
    (custom_animation "chief" "objects\characters\spartans\spartans" "depot:rifle:right_shoulder" true)
    (sleep 161)
    (custom_animation_loop "chief" "objects\characters\spartans\spartans" "depot:rifle:idle" true)
    (sleep_forever)
)
...
(script static void sleep_mainmenu (short seconds)
    (sleep_location 0 seconds)
)
...
(script static void sleep_campaign (short seconds)
    (sleep_location 1 seconds)
)
...
(script static void campaign_cam
    ...
    (sleep_until 
        (begin
            (sleep_campaign 0)
            (camera_set "theater_cam_02" 1200)
            (sleep_campaign 1200)
            (sleep_campaign 0)
            (camera_set "theater_cam_01" 1200)
            (sleep_campaign 1200)
            false
        )
    )
...
(script static void sleep_matchmaking (short seconds)
    (sleep_location 2 seconds)
)
...
(script static void sleep_custom (short seconds)
    (sleep_location 3 seconds)
)
...
(script static void sleep_editor (short seconds)
    (sleep_location 4 seconds)
)
...
(script static void sleep_theater (short seconds)
    (sleep_location 5 seconds)
)
...
(script static void sleep_activities (short seconds)
    (sleep_location 6 seconds)
)
...
(script static void activities_cam
    ...
    (sleep_until 
        (begin
            ...
            (sleep_activities 0)
            (camera_set "campaign_path_02" 1800)
            (sleep_activities 600)
            (sleep_activities 0)
            (camera_set "campaign_path_03" 1800)
            (sleep_activities 1800)
            (sleep_activities 0)
            (camera_set "campaign_path_04" 1800)
            (sleep_activities 1800)
            (sleep_activities 0)
...
(script static void sleep_unknown (short seconds)
    (sleep_location 7 seconds)
)

(script static void unknown_cam
    (set_location 7)
    (camera_set "custom_path_01" 0)
    (sleep_until 
        (begin
